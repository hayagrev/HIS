...
public class Reusable_methods 
{
	...
	public static void saveScreenshotsToWordDocument(String documentName,String[] screenshotNames) throws IOException
	{
		...
		headerRun.setText("CMS-Regression Test Results");
		headerRun.addBreak();
