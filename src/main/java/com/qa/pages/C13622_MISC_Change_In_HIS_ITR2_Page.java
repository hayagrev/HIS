...
public class C13622_MISC_Change_In_HIS_ITR2_Page extends BasePage {

	public C13622_MISC_Change_In_HIS_ITR2_Page(WebDriver driver) {
		super(driver);
	...
	private By presentPrimaryMobileNumberLable=By.id("ctl00_cphpage_lblpresentmobileNew");
	...
	private By ParmanantPrimaryMobileNumberTextbox=By.id("ctl00_cphpage_txtPermtMobileNoNew");
	...
	private By DoctorWorklist_informationMessageBox_CancelButton = By.id("ctl00_cphpage_MyMessageBoxInfo_ButtonCancel");
	public WebElement getDoctorWorklist_informationMessageBox_CancelButton() {
		return getElement(DoctorWorklist_informationMessageBox_CancelButton);
	...
	private By MedicationADDButton = By.id("btnADDM");
	public WebElement getMedicationADDButton() {
		return getElement(MedicationADDButton);

	}
	private By MedicationSearchTextBox = By.xpath("//*[@id='txtSearch']");
	public WebElement getMedicationSearchTextBox() {
		return getElement(MedicationSearchTextBox);

	}
	private By MedicationSearchCloseimage = By.xpath("//html//body//form//div[3]//div[2]//table//tbody//tr//td//div//table[1]//tbody//tr[1]//td//img");
	public WebElement getMedicationSearchCloseimage() {
		return getElement(MedicationSearchCloseimage);

	}
	private By PrescriptionWindowCloseButton = By.xpath("//*[@id='btnIClose']");
	public WebElement getPrescriptionWindowCloseButton() {
		return getElement(PrescriptionWindowCloseButton);

	}
	private By  MedicationSearchDrugDosetxtbox = By.xpath("//*[@id='txtDrugDose']");
	public WebElement getMedicationSearchDrugDosetxtbox() {
		return getElement(MedicationSearchDrugDosetxtbox);

	}
	private By  MedicationSearchDrugDoseDDL = By.xpath("//*[@id='ddlDrugDose']");
	public WebElement getMedicationSearchDrugDoseDDL() {
		return getElement(MedicationSearchDrugDoseDDL);

	}
	private By  MedicationSearchDurationtxtbox = By.xpath("//*[@id='txtDuration']");
	public WebElement getMedicationSearchDurationtxtbox() {
		return getElement(MedicationSearchDurationtxtbox);

	}
	private By  MedicationSearchFrequencyDDL = By.xpath("//*[@id='ddlFrequency']");
	public WebElement getMedicationSearchFrequencyDDL() {
		return getElement(MedicationSearchFrequencyDDL);

	}
	private By  MedicationSearchQuantitytxtbox = By.xpath("//*[@id='txtQuantity']");
	public WebElement getMedicationSearchQuantitytxtbox() {
		return getElement(MedicationSearchQuantitytxtbox);

	}
	private By  MedicationSearchQuantityDDL = By.xpath("//*[@id='ddlQuantityUOM']");
	public WebElement getMedicationSearchQuantityDDL() {
		return getElement(MedicationSearchQuantityDDL);

	}
	private By  ParacetamolTab500mgRDPL = By.xpath("//*[@id='36736']");
	public WebElement getParacetamolTab500mgRDPL() {
		return getElement(ParacetamolTab500mgRDPL);

	}
	private By  RoutofAdminDDL = By.xpath("//*[@id='ddlAdminRoute']");
	public WebElement getRoutofAdminDDL() {
		return getElement(RoutofAdminDDL);

	}
	private By  MedicineSearchOKButton = By.id("btnOK");
	public WebElement getMedicineSearchOKButton() {
		return getElement(MedicineSearchOKButton);

	}
	private By  MedicineSearchCloseButton = By.id("btnM");
	public WebElement getMedicineSearchCloseButton() {
		return getElement(MedicineSearchCloseButton);
	}
	private By  Prescription_MedicationBlock_MedicineNameRow = By.xpath("/html/body/form/div[3]/div[1]/fieldset/table/tbody/tr[5]/td/table/tbody/tr[1]/td/div/div[4]/table/tbody/tr[4]/td[3]/b");
	public WebElement getPrescription_MedicationBlock_MedicineNameRow() {
		return getElement(Prescription_MedicationBlock_MedicineNameRow);
	}
